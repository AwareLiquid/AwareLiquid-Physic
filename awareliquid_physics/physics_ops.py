"""
physics_ops.py -- composable Newtonian dynamics operators.

Why this module exists
----------------------
A scene is not static: to mentally simulate how events unfold needs a way to
*compute physical dynamics*, i.e. push a configuration forward in time under
forces and contacts. This module provides that layer: a small set of **composable,
...
The point is **composition**: a flagship query like
...
dynamics model. It is the ground-truth substrate the learned models in this
package (hamiltonian.py, model.py) are benchmarked against -- the
"compute, don't memorise" counterpart to a stored physics fact. Integration is first-order symplectic Euler: it is
